...
# following object is used to parse xml files.
...
open JSON, ">", "sitinfo.json" || die("unable to write JSON file");
print JSON encode_json \@hashsit;
close JSON;
...
# 0.75000  : Rename to sitinfo_json.pl
